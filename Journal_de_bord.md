...
Démarrage du prototype V1 incluant plusieurs fonctionnalités du cahier des charges ; 
multi-threading, système de scène(s). Modification des entités pour qu'elle ne possèdent seulement
des paramètres sans aucune logique. Par exemple, l'ajout du paramètre "static" pour désactiver la logique
